...
export default function SalvationAltarCall() {
  ...
  return (
    <section className="relative py-20 px-6 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
        ...
        >
          ...
          <div className="bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border border-indigo-500/20 rounded-xl p-8 mb-8">
            <p className="text-slate-300 text-center leading-relaxed mb-6">
              If you're ready to give your life to Jesus, pray this prayer with
              a sincere heart:
            </p>

            <div className="bg-slate-900/50 rounded-lg p-6 text-slate-200 italic text-center leading-relaxed">
              <p className="mb-4">
                "Lord Jesus, I believe You are the Son of God. I confess my sins
                and ask for Your forgiveness. I turn from my old ways and invite
                You into my heart and life. I want to trust and follow You as my
                Lord and Savior. In Your name, I pray. Amen."
              </p>
            </div>
          </div>
        ...
        >
          ...
          <ul className="space-y-3 text-slate-300">
            <li className="flex gap-3">
              ...
              <span>
                You'll receive a welcome email with resources for your new faith
                journey
              </span>
            </li>
            <li className="flex gap-3">
